...
namespace Loja.Controllers
{
    public class ItensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Quantidade,Fk_id_compra,Fk_id_produto")] Itens itens)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Quantidade,Fk_id_compra,Fk_id_produto")] Itens itens)
        {
            if (id != itens.Id)
            {
                return NotFound();
